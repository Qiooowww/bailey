...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    sendMessages: (jid: string, content: AnyMessageContent, options?: MiscMessageGenerationOptions) => Promise<proto.WebMessageInfo | undefined>;
    ...
    requestPairingCodes: (phoneNumber: any) => Promise<string | undefined>;
